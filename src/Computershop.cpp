...
/* getters */
const std::string& Computershop::getName() const
{
    return this->name;
}

const std::string& Computershop::getAddress() const
{
    return this->address;
}
...
void Computershop::saveToFile(const std::string& filename) const
{
...
void Computershop::readFromFile(const std::string& filename)
{
