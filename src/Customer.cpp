...
bool Customer::getCompany() const
{
    return this->company;
}
...
void Customer::serialize(std::ofstream& filestream) const
{
    ...
    /* write company */
    filestream.write(reinterpret_cast<const char*>(&this->company),
                     sizeof(this->company)); // write whether it's a businness client or not
